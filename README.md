# proj-weatherapp
This project demonstrates practical experience with REST API integration, asynchronous JavaScript, browser geolocation, error handling, and responsive frontend development.

A responsive real-time weather application built with JavaScript (ES6+), HTML5, and CSS3. The application integrates with third-party weather APIs to retrieve and display current weather information based on the user's location or a searched city.
